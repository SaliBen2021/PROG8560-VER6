...
const ShwarmaOrder = require("./assignment1OrderDetails");
//const SalmonOrder = require("./assignment1Salmon");// new
...
app.listen(port, () => console.log('Sali app listening on port ' + port + '!'));
